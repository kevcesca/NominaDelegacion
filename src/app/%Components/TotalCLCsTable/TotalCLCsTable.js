// src/app/%Components/TotalCLCsTable/TotalCLCsTable.js
...
const TotalCLCsTable = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://192.168.100.77:8080/totalCLCs');
    ...
    const exportExcel = () => {
        import('xlsx').then((xlsx) => {
            ...
            saveAsExcelFile(excelBuffer, 'totalCLCs');
        });
    };
    ...
    const header = (
        <div className="table-header">
            <h5 className="mx-0 my-1">Manage Total CLCs</h5>
