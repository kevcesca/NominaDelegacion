...
export default function ReporteDeNominaCuentaPorLiquidarPagoPorCheque() {
    ...
    const [endDate, setEndDate] = useState(dayjs('2024-01-31')); // Fecha de fin predefinida en enero
    ...
    const availableColumns = [
        ...
        { key: 'Tipo de Pago', label: 'Tipo de Pago' },
        { key: 'Número de Referencia o Cheque', label: 'Número de Referencia o Cheque' },
    ];
    ...
    const fetchData = async () => {
        ...
        const url = `${API_BASE_URL}/reporteNominaCuentaCheque?anio=${startDate.year()}&fechaInicio=${startDate.format(
            'YYYY-MM-DD'
    ...
    return (
        <Box display="flex" flexDirection="column" alignItems="center" padding="20px">
            <Typography variant="h4" gutterBottom>
                Reporte: Nómina Cuenta por Liquidar Pago por Cheque
            </Typography>
                ...
                <Grid container spacing={2} justifyContent="center" marginBottom="20px">
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        <DatePicker
                            ...
                            defaultCalendarMonth={dayjs('2024-01-01')} // Enfoca el calendario en enero de 2024
                            renderInput={(params) => <TextField {...params} fullWidth />}
                        />
                    </Grid>
