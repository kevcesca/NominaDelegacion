...
export default function Calendar() {
      ...
      for (let j = 0; j < 7; j++) {
        if ((i === 0 && j < firstDay) || date > daysInMonth) {
          ...
          const isHoliday = holidays.includes(
            `${String(month + 1).padStart(2, "0")}-${String(date).padStart(
              2,
              "0"
            )}`
          );
          ...
          row.push(
            <td
              key={j}
              className={`${isHoliday ? styles.holiday : ""} ${
  ...
  const addEvent = () => {
    if (selectedDate && eventTitle && eventDescription) {
      ...
      alert(
        "Selecciona una fecha y completa los campos de título y descripción para agregar un evento."
      );
    }
  };
      ...
      <div className={styles.containerContent}>
          ...
          <aside className={styles.sidebar}>
            ...
            <div className={styles.eventForm}>
              ...
              <div className={styles.buttons}>
                ...
                <button onClick={deleteEvent}>Eliminar Evento</button>
              </div>
            </div>
          </aside>
        </div>
        ...
        <div className={styles.extraContainer}>
          ...
          <div className={styles.exportButtons}>
            ...
            <button onClick={exportExcel}>XLS</button>
